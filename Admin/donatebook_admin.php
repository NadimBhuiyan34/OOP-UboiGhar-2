...
use uboighar\sql_operation\insertdata;
 //this is read data part
  ...
  //this is delete data part
  if(isset($_REQUEST['did']))
  {
   $table="donate_book";
   $filename="donatebook_admin.php";
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><img src="<?php echo "http://localhost/Book_Store_Demo/images/donatebook/".trim($row['book_image'])?>" alt="" style="height:100px;width:100px"></td>
        <td>
          <a href="donatebook_admin.php?did=<?php echo $row['id']?>">
          <button type="submit" class="fa-solid fa-trash-can btn-white btn btn-sm ml-2" name="delete"></button></a>
          <a href="donatebook_admin.php?id=<?php echo $row['id']?>"><button type="submit" class="fa-solid fa-pencil ml-3 btn-white btn btn-sm "></button>
        </a>
        </td>
