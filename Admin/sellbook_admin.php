  ...
  <table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="sellbook_admin.php?did=<?php echo $row['id']?>">
          <button type="submit" class="fa-solid fa-trash-can btn-white btn btn-sm ml-2" name="delete"></button></a>
          <a href="sellbook_admin.php?id=<?php echo $row['id']?>"><button type="submit" class="fa-solid fa-pencil ml-3 btn-white btn btn-sm "></button>
        </a>
        </td>
